...
\lstdefinelanguage{Golang}{
  keywords={break, case, catch, continue, default, defer, delete, do, else, false, for, func, type, if, in, make, new, nil, return, switch, select, error, true, typeof, while},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
  ndkeywords={struct, import},
  keywordstyle=\color{blue}\bfseries,
  ndkeywordstyle=\color{darkgray}\bfseries,
  identifierstyle=\color{black},
  commentstyle=\color{purple}\ttfamily,
...
\lstdefinelanguage{Protobuf}{
  keywords={int64,uint64,bool,enum,bytes},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
  ndkeywords={syntax,message,package},
  keywordstyle=\color{blue}\bfseries,
  ndkeywordstyle=\color{darkgray}\bfseries,
  identifierstyle=\color{black},
  commentstyle=\color{purple}\ttfamily,
...
\usepackage{tabularx} % table with 'X' (auto-width) column
\usepackage{ltablex} % multi-page tabularx (table) span
% \renewcommand{\arraystretch}{2}
\newcolumntype{P}[1]{>{\hspace{0pt}}p{#1}} % hyphenate first word in column
